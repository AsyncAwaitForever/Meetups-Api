...
export const loadMeetups = async () => {
    try {
        ...
        const existingMeetups = await dynamoDbUtils.scanItems({ TableName: meetupsTable, Limit: 1 });
      ...
      return { success: false, message: "Failed to load meetups.", error: error.message };
    }
};